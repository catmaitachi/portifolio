...
Quem avalia o candidato para uma vaga ou um estágio.

**HU04.** Como recrutador montando um parecer, quero percorrer a trajetória em ordem cronológica e ler o cargo, a organização, o período, as atividades e as tecnologias de cada etapa, para acompanhar a progressão dele ao longo do tempo.

**HU05.** Como recrutador verificando os requisitos da vaga, quero ver a formação com o estado de cada uma, concluída, em andamento com o quanto já foi cumprido ou pretensão futura, para saber onde ele está academicamente hoje.

**HU06.** Como recrutador de um time que não fala português, quero passar a página para o inglês num clique e continuar na seção em que estava, para ler o material e encaminhá-lo aos colegas.
